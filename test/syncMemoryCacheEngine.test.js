...
describe('syncMemoryCacheEngine', function() {
  ...
  describe('#get()', function() {
    it('should return undefined for a key that has not been set', function() {
      var memory = require('../syncMemoryCacheEngine').createSyncMemoryCacheEngine();
  ...
  describe('#length', function() {
    ...
    it('should return 0 after something added has expired', function(done) {
      var memory = require('../syncMemoryCacheEngine').createSyncMemoryCacheEngine({ gcInterval: 10 });
    ...
    it('should not exceed cache size', function() {
      ...
      var memory = require('../syncMemoryCacheEngine').createSyncMemoryCacheEngine({ size: 3 });
